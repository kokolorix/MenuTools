...
#define MT_MENU_SEPARATOR1					WM_USER + 0x2030 + 1
#define MT_MENU_SEPARATOR2					WM_USER + 0x2030 + 2
#define MT_MENU_SEPARATOR3					WM_USER + 0x2030 + 3
#define MT_MENU_SEPARATOR4					WM_USER + 0x2030 + 4
